...
public class BlockBdmcFalloutAndesiteSlab extends ElementsBdmcModMod.ModElement {
	@GameRegistry.ObjectHolder("bdmc_mod:bdmc_fallout_andesite_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("bdmc_mod:bdmc_fallout_andesite_slab_double")
	public static final Block block_slab_double = null;
	public BlockBdmcFalloutAndesiteSlab(ElementsBdmcModMod instance) {
		super(instance, 18);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bdmc_fallout_andesite_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("bdmc_fallout_andesite_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("bdmc_mod:bdmc_fallout_andesite_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("bdmc_fallout_andesite_slab");
